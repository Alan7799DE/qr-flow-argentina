    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <form onSubmit={handleCreate} className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Button type="submit" variant="hero" size="lg" className="flex-1" <Button type="submit" variant="hero" size="lg" className="flex-1" disabled={createQR.isPending || isValidatingUrl}>>
            {isValidatingUrl ? (
