...
import { QrCode, ArrowLeft, Loader2, Eye, EyeOff, Mail } from "lucide-react";
            ...
            {forgotEmailSent ? (
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  Te enviamos un enlace a <strong>{forgotEmail}</strong> para restablecer tu contraseña.
                </p>
                <p className="text-sm text-muted-foreground mb-6">
                  ¿No lo recibiste? Revisá tu carpeta de spam o intentá de nuevo.
                </p>
                <Button
                  variant="outline"
                  size="lg"
