...
const navItems = [
  ...
  { icon: BarChart3, label: "Estadísticas", path: "/dashboard/stats", gtm: "nav-estadisticas" },
  { icon: CreditCard, label: "Facturación", path: "/dashboard/billing", gtm: "nav-facturacion" },
